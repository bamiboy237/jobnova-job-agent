...
4. In application mode, use inspect_current_page and application_capabilities before mapping fields. Retrieve approved facts only when semantics require them. Use typed execute_application_actions batches for stable independent fields and protected individual tools for dynamic recovery. Reinspect after every dynamic barrier, upload, stale ref, or step advance.
